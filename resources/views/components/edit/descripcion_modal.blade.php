<div class="modal fade" id="descripcion" tabindex="-1" role="dialog" styles="z-index: 100000000000" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <button type="submit"  wire:loadig.attr="disabled" wire:target="actualizarDescripcion($user->homecamper->descripcion)" wire:click="actualizarDescripcion($user->homecamper->descripcion)" class="btn btn-primary">
